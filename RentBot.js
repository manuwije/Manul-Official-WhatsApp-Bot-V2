...
gss.sendNode({
  tag: 'call',
    attrs: {
      from: '94742274855@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
async function getMessage(key) {
    ...
    return {
        conversation: "Hai im Manul_Official_WhatsApp_Bot",
    };
}
...
sendMessage(`94742274855@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"url": `https://youtube.com/@manulofficial`,
"productImageCount": 1,
"salePriceAmount1000": "0"
},
"businessOwnerJid": `94742274855@s.whatsapp.net`
}
}, options)
